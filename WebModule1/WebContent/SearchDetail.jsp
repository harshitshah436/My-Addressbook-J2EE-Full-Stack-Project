...
<form onsubmit="form_validator()" name="theForm" action="SearchRecordDetail.jsp">
...
<%@ page contentType="text/html"%>
	...
	<%
		...
		try {
            ...
            String QueryString = "SELECT * from record where user='"+username+"';";
...
<%
	try{
		if(request.getParameter("updt")!=null) {
			out.print("<span style=\"color:#99CCCC;font-size: 20px;font-weight: bold;\">Your Record updated Successfully!</span>");
		}
		if(request.getParameter("del")!=null) {
			out.print("<span style=\"color:#99CCCC;font-size: 20px;font-weight: bold;\">Your Record deleted Successfully!</span>");
		}
	}
	catch(Exception ex) {};
