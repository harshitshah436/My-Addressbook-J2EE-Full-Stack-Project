...
<p align="center">&nbsp;</p>
<%
	if(request.getParameter("regflg")!=null) {
		out.println("<span style=\"color:green; font-size:medium; font-weight:bold;\">Your Account is created successfully, Use your Username and Password for maintaining your AddressBook!</span><br>");
	}
%>
...
<blockquote>
   <ul>
    	<li> Add or update contacts with ease...</li>
    	<li> Detailed notes...</li>
    	<li> High capacity...</li>
    	<li> High performance...</li>
    	<li> Organize your contacts...</li>
    	<li> Access from any web-connected device...</li>
   ...
   'My address book' pulls it together automatically so your address book is always up-to-date,accurate,and ready to go when and where you need it.Because change happens!!</li>
    </ul>
</blockquote>
